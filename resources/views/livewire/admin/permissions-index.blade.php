        ...
        <div class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 z-10">
            ...
            <div class="relative h-full w-full p-6 rounded shadow z-10">
                ...
                <form wire:submit.prevent="store()">
                    <div class="mb-4">
                        <flux:input wire:model="name" :label="__('Clave')" type="text" required autofocus autocomplete="clave" placeholder="Ingrese la clave" />
                    </div>
                    <div class="mt-4">
                        <flux:input wire:model="description" :label="__('Descripción')" type="text" required autofocus autocomplete="Descripción" placeholder="Ingrese descripción" />
                    </div>
                ...
                @endcan
                <div class="mt-4">
                    <flux:input wire:model.live="search" icon="magnifying-glass" :label="__('Buscar')" type="text" required autofocus autocomplete="Buscar" placeholder="Ingrese clave o slug" />
                </div>
            </div>
                ...
                <table class="w-full table-auto text-left border-collapse">
                    ...
                    <tbody class="text-sm">
                        ...
                        <tr class="text-center">
                            ...
                            <td class="px-4 py-2">
                                <flux:button wire:click="destroy('{{ $permission->id }}')" variant="primary" class="cursor-pointer hover:bg-red-200" size="sm">🗑️</flux:button>
                            </td>
                            @endcan
                        </tr>
                        @endforeach
